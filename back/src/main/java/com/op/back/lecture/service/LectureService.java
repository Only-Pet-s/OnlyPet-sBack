...
public interface LectureService {
    ...
    void uploadVideo(String lectureId, MultipartFile video, MultipartFile thumbnail, String title, String description, int order, boolean preview, String currentUid);
